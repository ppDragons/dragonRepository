            ...
            <div class="container">
                <div class="row">
                    ...
                    <div style="margin:0 auto;width:950px;"style="float:left;">
                        <div class="col-md-6">
                            <img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${product.proMinImage}">
                            ...
                            <div class="col-md-6" style="float: right;">
                                ...
                                <div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">${product.shopPrice}</strong> 参 考 价： <del>${product.marketPrice}</del>
                                </div>
                                ...
                                <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                                    ...
                                    <form action="/CartServlet?method=inputProduct" method="post">
                                        <input type="hidden" value="${requestScope.product.proId}" name="id">
