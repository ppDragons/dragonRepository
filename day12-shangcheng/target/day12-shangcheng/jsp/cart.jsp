            ...
            <c:forEach items="${sessionScope.cart}" var="item">
                <tr>
                    <td width="60" width="40%" style="border-right: 1px solid gray;">
                        ...
                        <img src="../${item.key.proMinImage}" width="70" height="60">
                    </td>

                    <td width="30%" style="border-right: 1px solid gray;">
                        <a target="_blank">${item.key.proName}</a>
                    </td>
                    ...
                    <td width="10%" style="border-right: 1px solid gray;">
                        <input type="text" name="quantity" value="${item.value}" maxlength="4" size="10" >
                    </td>
                    <td width="15%" style="border-right: 1px solid gray;">
                        <span class="subtotal">${item.value*item.key.shopPrice}</span>
                    </td>
                    <td style="border-right: 1px solid gray;">
                        <a href="/CartServlet?method=deleteProduct&id=${item.key.proId}" class="delete" onclick="return confirm('是否删除')">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
